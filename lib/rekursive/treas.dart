void main() {
  ...
  baum.linkeZweige!.rechteZweige!.rechteZweige!.rechteZweige!.rechteZweige =
      Baum(blatte: 5);
  baum.linkeZweige!.rechteZweige!.rechteZweige!.rechteZweige!.linkeZweige =
      Baum(blatte: 5);
...
int blattenSumme(Baum? baum) {
  ...
  return baum.blatte +
      blattenSumme(baum.linkeZweige) +
      blattenSumme(baum.rechteZweige);
}
